 ...
 * @author User
 */
public class TelaConsultarDenuncias1 extends javax.swing.JFrame {
     ...
     */
    public TelaConsultarDenuncias1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultarDenuncias1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultarDenuncias1().setVisible(true);
            }
        });
    }
